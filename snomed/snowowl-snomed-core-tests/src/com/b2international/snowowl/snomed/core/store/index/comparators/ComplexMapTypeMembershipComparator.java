 ...
 * @since 5.0
 */
public class ComplexMapTypeMembershipComparator extends MembershipComparator<ComplexMapTypeMembership> {
	@Override
	public int compare(ComplexMapTypeMembership o1, ComplexMapTypeMembership o2) {
