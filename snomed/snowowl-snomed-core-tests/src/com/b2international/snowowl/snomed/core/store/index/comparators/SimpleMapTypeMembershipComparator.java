 ...
 * @since 5.0
 */
public class SimpleMapTypeMembershipComparator extends MembershipComparator<SimpleMapTypeMembership> {
	@Override
	public int compare(SimpleMapTypeMembership o1, SimpleMapTypeMembership o2) {
