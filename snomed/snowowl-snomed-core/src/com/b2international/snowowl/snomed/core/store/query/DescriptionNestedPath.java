 ...
 * @since 5.0
 */
public enum DescriptionNestedPath implements NestedPath {
	MEMBERSHIPS(SnomedIndexConstants.DESCRIPTIONS + "." + SnomedIndexConstants.MEMBERSHIPS);

	private final String path;
	
	private DescriptionNestedPath(String path) {
		this.path = path;
	}
