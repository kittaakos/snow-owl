...
/**
 * Represents an extended map type reference set membership.
 * 
 * @since 5.0
 */
public class ExtendedMapTypeMembership extends Membership {
	...
	public ExtendedMapTypeMembership() {
		super(ReferenceSetType.EXTENDED_MAP);
	}
	...
	void setMapCategoryId(String mapCategoryId) {
