 ...
 * @since 5.0
 */
public enum RelationshipMembershipFeature implements NestedFeature {
	...
	private RelationshipMembershipFeature(String field) {
	...
	public NestedPath getPath() {
		return RelationshipNestedPath.MEMBERSHIPS;
	}
}